...
export default function Intro() {
    return (
        <section className="h-screen text-left sm:mb:0 sm:mt-4 flex flex-col justify-center sm:flex-row">
            ...
            <div className="flex flex-col mt-32 sm:flex-row ">
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    >
                        <p className="text-blue-700 mb-4 text-xl">Hi, my name is</p>
                        ...
                        transition={{ delay: 0.1 }}>
                            ...
                            <a href="/Cirriculum Vitae of Sachin Ramsamy.pdf" download className="group mt-8 flex items-center text-blue-700 border border-blue-700 rounded-md px-4 py-3 gap-2 outline-none focus:scale-110 hover:scale-110 hover:text-blue-600 hover:border-blue-500 hover:bg-black active:scale-105 transition">Resume <HiDownload className="opacity-70 group-hover:translate-y-1 transition" /></a>
                        </motion.div>
                    </motion.h1>
