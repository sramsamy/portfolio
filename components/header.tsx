...
export default function Header() {
	...
	return (
		<header className="z-[999] relative px-4">
			<div className="sm:flex top-0 left-0 h-12 py-2 pl-2 sm:h-[initial] sm:py-0 hidden">
			...
			>
				<nav className=" flex fixed top-0 h-12 py-2 sm:h-[initial] sm:py-0 justify-end">
					<ul className="flex w-[22rem flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-blue-600 sm:w-[initial sm:flex-nowrap sm:gap-5 mr-5 text-base">
						{links.map((link) => (
							<motion.li
							...
							>
								<Link
									className={clsx(
										"flex w-full items-center justify-center px-2 py-3 hover:text-blue-700 transition gap-2",
										{
